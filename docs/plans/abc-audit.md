...
### Підсумок перевірки — 2026-09-17

Другу незалежну причину L-відмови відтворив GUI-тест з оверлеєм:
Tk deiconify на Windows забирав фокус попри встановлений NOACTIVATE style.
Windows-оверлей замінено нативним Win32 вікном із WS_EX_NOACTIVATE та
SW_SHOWNOACTIVATE, без відновлення/перенесення фокусу. macOS/Linux не змінені.

Код виправлення: `a886743`. [CI: всі шість jobs успішні](https://github.com/trybushenko/voice-to-clipboard/actions/runs/35154418962).
Windows Python 3.11 і 3.12 виконали 60 unit/integration тестів та GUI-сценарії:
точний Unicode вставлено один раз із реальним оверлеєм; перехід між Win32 EDIT
полями з поверненням блокує вставку. Це регресійні тести без мікрофона;
повторне L-приймання на машині користувача залишається відкритим.


## Windows-приймання — 2026-09-17

Користувач підтвердив: «все працює, все чудово» після виправлень focus/overlay
та дозволив merge в main. B/C прийняті на його Windows-машині; детальні
hardware/версії не надані, macOS фізичне приймання не підміняємо цим результатом.
Наступна робота — D в окремій тестовій гілці `codex/desktop-tray-autostart`.
